  ...
  return (
    <div className="absolute inset-0">
      ...
      <div className="hidden md:block">
        <div className="absolute h-[2px] w-[200%] bg-gradient-to-r from-transparent via-[#80a94b] to-transparent top-1/2 -left-1/2 transform -rotate-45 animate-[pulse_4s_ease-in-out_infinite] dark:opacity-70 opacity-40" />
        <div className="absolute h-[1px] w-[200%] bg-gradient-to-r from-transparent via-[#375436] to-transparent top-[45%] -left-1/2 transform -rotate-45 animate-[pulse_4s_ease-in-out_infinite_1s] dark:opacity-50 opacity-30" />
      </div>
